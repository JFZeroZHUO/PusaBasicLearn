// 第1周章节数据
export const week1Chapters = [
  {
    id: 'chapter1',
    number: 1,
    title: '出图技巧：用4张图讲一个故事',
    icon: '🎨',
    learningIntro: '做AI视频之前先出图，是因为“图”决定了视频的内容质量。先把角色、场景、氛围和镜头节奏在静态画面里定清楚，后面图生视频才会稳定、连贯，不容易出现人物变形或风格跳变。你可以把这一步理解为拍片前的分镜和美术设定：先把故事讲明白，再让它动起来。',
    customHtml: `
<style>
    .chapter1-suno {
        --bg-base: #f8fafc;
...
<div class="container">
    ...
    toolComparison: {
      ...
      compareRows: [
        {
          dimension: '风格美学',
          mj: '更容易做出电影海报感、艺术化、强风格画面，视觉冲击力更强。',
          jimeng: '更偏叙事清晰与写实稳定，中文语义理解直观，表达更稳。'
        },
        {
          dimension: '图片质感',
          mj: '光影层次、材质细节、氛围张力通常更惊艳，适合做“炸点镜头”。',
          jimeng: '人物一致性、场景可控性、批量出图稳定性更友好。'
        },
        {
          dimension: '应用场景',
          mj: '封面图、概念设定图、关键帧、风格探索与视觉拔高。',
          jimeng: '课程作业、短视频分镜、连续四图讲故事、快速迭代。'
        }
      ],
      recommendations: [
        '新手建议：先用即梦建立“故事表达 + 稳定出图”能力，再逐步用MJ训练风格和高级质感。',
        '高手建议：即梦负责叙事一致性，MJ负责关键镜头风格拔高与精修，两者混用效率最高。'
      ]
    },
    objectives: [
      '学会AI绘画基础操作',
    ...
    resources: [
      {
        ...
        link: 'https://fclive.pandacollege.cn/p/2wrYTR',
        linkText: '📺 直播回放',
        items: [
      ...
      },
      {
        ...
        badge: '必学',
        title: 'MJ出图课程',
        description: '掌握MJ出图的基础流程与使用技巧',
        links: [
          { url: 'https://fc0.cc/320e1t/1HB5Q', label: '📹 视频教程' },
          { url: 'https://xueshanlinghu.github.io/MJPromptGenerator/', label: '🛠️ MJ提示词生成器' },
          { url: 'https://art.forchange.cn/mj', label: '🎨 打开风变MJ开始创作' }
        ],
        moveToTaskStep: 3,
        half: true
      },
      {
        ...
        badge: '必学',
        title: '即梦AI出图完整教程',
        description: '掌握即梦AI的出图、编辑、参考功能',
        links: [
          { url: 'https://fc0.cc/320e1t/1GZmM', label: '📹 视频教程' },
          { url: 'https://bytedance.larkoffice.com/docx/EkCsd3iGvoxUnExu0Q8ccGt3n6c', label: '📖 即梦提示词手册' },
          { url: 'https://jimeng.jianying.com/', label: '🎬 打开即梦开始创作' }
        ],
        moveToTaskStep: 3,
        half: true
      }
    ...
    practiceTasks: [
      {
        step: 1,
        title: '构思你的故事',
        description: '先定一个小小的微型故事，再用“起承转合”折成4幕',
        exampleLabel: '故事示例',
        scriptExample: {
          core: '【示例】小女孩发现猫咪走失后焦急寻找，最终在雨夜巷口寻回并带回家中温暖相拥。',
          scenes: [
            { title: '图一 | ① 交代人物与环境', content: '小女孩看着空空如也的猫窝，神情茫然失措。' },
            { title: '图二 | ② 行动推进', content: '黄昏时分，她拿着手绘的寻猫启事，在街头焦急地四处寻觅。' },
            { title: '图三 | ③ 冲突或转折', content: '大雨滂沱的黑夜，她终于在暗巷的角落里，找到了瑟瑟发抖的小橘猫。' },
            { title: '图四 | ④ 结果或情绪收尾', content: '回到温暖的家中，一人一猫裹着干毛巾，安心地紧紧相拥。' }
          ]
        },
        tips: [
          '四图结构建议：<strong>①交代人物与环境</strong> <strong>②行动推进</strong> <strong>③冲突或转折</strong> <strong>④结果或情绪收尾</strong>。',
          '如果你不能用一句话讲清故事，说明题材太大，继续缩小。'
        ],
        quiz: {
          question: '你觉得，这四个图的文字，可以直接用来给AI生成图片了吗？',
          options: ['可以', '不可以'],
          correctAnswer: '不可以',
          explanation: `
      ...
      },
      {
        step: 2,
        title: '写出4个图片的提示词',
        description: '用“小女孩找回走失小猫”做四图示例：同一角色、同一画风、四个镜头讲完整故事。',
        example: '四图叙事：放学回家发现小猫不见 → 在小巷四处寻找 → 雨夜巷口终于找到 → 抱着小猫回到温暖的家。',
        exampleGuideIntro: '尝试写出你自己设计的4图故事的具体图片提示词，至少是能包含',
        exampleGuideList: [
          '画面风格：用 the film still of 电影静帧的风格',
          '画面景别/视角/镜头：远景、中景、特写、过肩拍、仰拍视角、俯拍....',
          '画面具体内容'
        ],
        exampleLabel: '4图故事示例',
        aiAssist: {
          url: 'https://ai-edu.aigcfun.com/chat-tool/chat',
          btnText: '打开风变AI对话工具，建议用【高级推理模型】，或【编程模型】',
          prompt: '我要用midjourney出四张图，做一个小女孩找回走失小猫的小视频。\n开场发现小猫不见 → 线索追寻 → 在雨夜巷口找到 → 抱着小猫回家。\n你帮我设计四张图的图片提示词，用上the film still of',
          result: [
            {
              title: '画面一：开场（发现不见）',
              desc: '剧情/镜头：交代故事起因。小女孩拿着一个空的猫项圈，看着空荡荡的猫窝，神情失落。空气中弥漫着安静且悬疑的氛围。',
              prompt: 'The film still of a 7-year-old little girl standing in her living room, holding an empty cat collar in her small hands. She is staring sadly at an empty fluffy cat bed on the floor. Warm but melancholic afternoon sunlight streaming through the window, revealing dust motes in the quiet air. Cinematic lighting, shot on 35mm lens, photorealistic, subtle emotional expression. --ar 16:9 --style raw --v 6.0',
              translation: '中文释义：电影剧照，一个7岁的小女孩站在客厅里，小手里拿着一个空的猫项圈。她正伤心地盯着地板上一个毛茸茸的空猫窝。温暖却略带忧郁的午后阳光透过窗户照射进来，照亮了安静空气中的灰尘。电影级光影，35mm镜头拍摄，照片级写实，细腻的情感表达。'
            },
            {
              title: '画面二：线索追寻（黄昏寻觅）',
              desc: '剧情/镜头：小女孩走到户外，手里拿着自己用蜡笔画的“寻猫启事”，在街头焦急地四处张望。天色渐暗，预示着寻找的困难。',
              prompt: 'The film still of a worried 7-year-old little girl standing on a dim suburban street at dusk, holding a handmade "Missing Cat" flyer with a child\'s crayon drawing of an orange cat. She is looking around anxiously. Blue hour lighting, streetlights just beginning to flicker on in the background, cool cinematic color grading, shallow depth of field, realistic textures. --ar 16:9 --style raw --v 6.0',
              translation: '中文释义：电影剧照，黄昏时分，一个焦急的7岁小女孩站在昏暗的郊区街道上，手里拿着一张手工制作的“寻猫启事”（上面有儿童蜡笔画的橘猫）。她正焦急地四处张望。蓝调时刻的光线，背景里的路灯刚刚开始闪烁亮起，冷色调电影级调色，浅景深，真实的质感。'
            },
            {
              title: '画面三：高潮（雨夜巷口找到）',
              desc: '剧情/镜头：情绪爆发点。大雨滂沱的黑夜，小女孩穿着黄色雨衣蹲在积水的巷口，向躲在纸箱里发抖的小橘猫伸出手。',
              prompt: 'The film still of a little girl wearing a bright yellow raincoat, crouching in a dark, wet alleyway during heavy rain at night. She is gently reaching out her hand to a tiny, shivering orange tabby kitten hiding inside a soggy cardboard box. Dramatic cinematic backlighting from a distant street lamp, heavy raindrops catching the light, reflections on the wet asphalt, highly emotional, Arri Alexa 65. --ar 16:9 --style raw --v 6.0',
              translation: '中文释义：电影剧照，夜里下着大雨，一个小女孩穿着明黄色的雨衣，蹲在黑暗潮湿的小巷里。她正温柔地向躲在湿透纸箱里、瑟瑟发抖的小橘猫伸出手。远处路灯投下充满戏剧性的电影级逆光，大雨滴折射着光芒，潮湿柏油路面的倒影，极具情感张力，Arri Alexa 65 摄影机。'
            },
            {
              title: '画面四：结局（抱着小猫回家）',
              desc: '剧情/镜头：温暖的结局。回到家中，小女孩和小猫都用毛巾包裹着，紧紧依偎在一起，背景是窗外的冷雨，与室内的暖光形成极致对比。',
              prompt: 'The film still of a happy and relieved little girl sitting on a cozy rug inside a warm room, tightly hugging a small orange tabby kitten wrapped in a dry fluffy towel. Both have their eyes closed in comfort. Warm amber tungsten light from a nearby lamp illuminating their faces, contrasting with the cold, dark, rainy night visible through the window behind them. Intimate close-up, soft cinematic focus, heartwarming masterpiece. --ar 16:9 --style raw --v 6.0',
              translation: '中文释义：电影剧照，一个开心且如释重负的小女孩坐在温暖房间舒适的地毯上，紧紧抱着一只裹在干燥蓬松毛巾里的小橘猫。他们都舒服地闭上了眼睛。旁边台灯发出温暖的琥珀色钨丝灯光照亮了他们的脸庞，与背后窗外寒冷、黑暗的雨夜形成对比。亲密的特写镜头，柔和的电影级焦点，温暖人心的杰作。'
            }
          ]
        }
      },
      {
        step: 3,
        title: '开始生成图片',
        description: '打开AI工具，生成你的4张故事图。也可以直接使用公开课的作业。'
      }
    ],
    chapterTask: {
      description: '我已学会生成4张故事图',
      tips: '确保4张图片风格统一、故事连贯'
    }
  },
  {
    id: 'chapter2',
    ...
    resources: [
      {
        ...
        items: [
          ...
          '组合示例：镜头缓慢推近，人物转身看向镜头，衣角随风摆动，背景云层缓慢流动。'
        ]
      },
      {
        type: 'optional',
    ...
    practiceTasks: [
      ...
      },
      {
        step: 2,
        title: '选择AI视频工具',
        description: '推荐使用即梦或可灵，将4张图片分别生成视频片段',
        tools: [
          { name: '即梦', url: 'https://jimeng.jianying.com/', desc: '操作简单，效果稳定' },
          { name: '可灵', url: 'https://app.klingai.com/cn/', desc: '功能强大，效果多样' }
        ]
      },
      {
        step: 3,
    ...
    resources: [
      {
        ...
        badge: '必学',
        title: '剪映基础剪辑教程',
        description: '学习剪映的基本操作和剪辑技巧',
        duration: '20分钟',
        link: 'https://fclive.pandacollege.cn/p/1WE4uE',
        linkText: '▶️ 观看直播回放'
      },
      {
        type: 'important',
        badge: '工具',
        title: '剪映下载',
        description: '专业级视频剪辑工具，免费易用',
        links: [
          { url: 'https://www.capcut.cn/', label: '📥 下载剪映' }
        ]
      }
    ],
    practiceTasks: [
      {
        step: 1,
        title: '安装并打开剪映',
        description: '下载并安装剪映，创建新项目',
        actionLink: 'https://www.capcut.cn/',
        actionText: '📥 下载剪映'
      },
      {
        step: 2,
        title: '导入视频素材',
        description: '将第2步生成的4个视频片段按故事线顺序拖入时间线',
        example: '确保视频顺序符合你的故事逻辑：开头 → 发展 → 高潮 → 结尾'
      },
      {
        step: 3,
        title: '添加背景音乐',
        description: '从剪映音乐库选择合适的背景音乐，或者使用SUNO生成原创音乐',
        tips: [
          '选择与故事氛围匹配的音乐',
          '注意音乐的节奏，在节奏点上切换画面',
          '可以使用SUNO生成原创音乐（第2周会详细讲解）'
        ]
      },
      {
        step: 4,
        title: '调整视频节奏',
        description: '对视频素材进行【变速】或【裁剪】处理，让视频素材能够卡在背景音乐的节奏点上',
        example: '在鼓点处切换画面，在高潮处使用特写镜头'
      },
      {
        step: 5,
        title: '添加音效',
        description: '最后添加一些【转场音效】或是【环境音效】，让视频更丰富',
        example: '添加脚步声、环境音、转场音效等'
      },
      {
        step: 6,
        title: '导出并分享',
        description: '导出你的视频作品，发到【野菩萨入门基础学习群】里',
        actionText: '🎉 完成作品'
      }
    ],
    assignments: [
      {
        ...
        submitSteps: [
          ...
          },
          {
            step: 2,
            instruction: '填写提交表单',
            url: 'https://forchangesz.feishu.cn/share/base/form/shrcnyEngJJgSJqdnp1FbMfizjf',
            btnText: '📝 点击提交作业'
          }
        ],
        tips: '对视频剪辑审美要求不高，确保会按基础剪辑步骤完成简单剪辑'
      }
    ],
    chapterTask: {
      description: '我已完成第一个AI视频作品',
      tips: '最终视频时长5-20秒，卡在音乐节奏点上'
    }
  },
  {
    id: 'chapter4',
    number: 4,
    title: '第1课：零基础变身AI大导的“降维打击”指南',
    icon: '📸',
    customHtml: `
<div class="container">
    <h1>🎬 风变野菩萨AI视频社团</h1>
    ...
    objectives: [
      ...
      '使用光线营造不同氛围',
      '能独立创作出构图合理、质感高级的AI摄影作品'
    ],
    resources: [
      {
        type: 'required',
        badge: '第1课',
        title: '🎬摄影基础1：0622 摄影课提示词教学：摄影师的前四招',
        description: '🎬摄影基础1：0622 摄影课提示词教学：摄影师的前四招',
        links: [
          { url: 'https://fc0.cc/320e1t/1FxR8', label: '📺 观看第1课视频：摄影师的前四招' }
        ]
      },
      {
        type: 'important',
        badge: '警告',
        title: '⚠️ 在此之前，你可能一直在“假装”做AI视频',
        description: '嗨，未来的 AI 大导演，欢迎来到风变野菩萨！👋',
        items: [
          '你是不是经常在 AI 输入框里敲下几百个字的“小作文”，把画面细节描述得清清楚楚，满心欢喜地按下回车……结果，AI 却甩给你一张一眼假的“塑料感网图”，或者构图极其呆板的“大头贴”？',
          '你可能会怀疑：是不是我用的工具不行？是不是我没有艺术细胞？都不是。',
          '真相是：你一直在用“画画”的思维要求 AI，但顶级 AI 创作者，都在用“导演”的思维操控 AI。',
          '所有的 AI 视频，都是由一帧帧静止的画面组成的。不懂 AI 摄影，你生成的视频就永远只是动起来的 PPT。'
        ]
      },
      {
        type: 'important',
        badge: '颠覆',
        title: '第一课认知颠覆：不要命令AI，要学会“贿赂”它',
        description: '提示词不是命令，而是权重（筹码）。',
        items: [
          '很多小白觉得，AI 是个听话的仆从，我说什么它就画什么。大错特错！',
          'AI 其实是一个天赋异禀但非常有主见（甚至有点瞎）的疯子。',
          '你命令它：“给我拍一张美女的全身照，她有迷人的大眼睛。”AI 听到“大眼睛”兴奋了，为了把眼睛画清楚，它会把镜头无限拉近——恭喜你，全身照变成了一张怼脸大头贴。',
          '🔑 核心内幕：提示词不是命令，而是“权重（筹码）”！',
          '🤫 老手暗语：`full body shot` (全身照) + `standing on road` (站在路上) + `wearing shoes` (穿着鞋子)'
        ]
      },
      {
        type: 'important',
        badge: '作弊码',
        title: '第二课偷师好莱坞：5个让画面变贵的开关',
        description: '为什么别人电影感拉满，你像劣质网游？因为没开这5个开关。',
        items: [
          '🔘 开关 1：操控观众眼球的“虚化滤镜” -> `DOF`（景深）',
          '🌟 进阶暗语：`bokeh` (梦幻光斑)',
          '🔘 开关 2：摆脱呆板视角的“空间魔法” -> `high angle shot` + `panorama` / `makeup shot` / `back shot`',
          '🔘 开关 3：掌控时间的“时空遥控器” -> `bullet time` / `long exposure`',
          '🔘 开关 4：注入灵魂的“光影调色盘” -> `cinematic lighting` / `Rembrandt lighting` / `neon lighting`',
          '🔘 开关 5：干掉“AI塑料感”的复古滤镜 -> `film grain` / `Kodak 400`'
        ]
      },
      {
        type: 'important',
        badge: '大师',
        title: '第三课降维打击：一键“召唤”摄影大师',
        description: '魔法句式：`photography by [摄影师名字]`',
        items: [
          '想生成一张能登上《VOGUE》杂志封面的超模大片？👉 召唤时尚界鬼才：`by Nick Knight`',
          '想生成一张让人巨物恐惧发作的史诗级大景？👉 召唤宏大场景之王：`by Andreas Gursky`'
        ]
      },
      {
        type: 'important',
        badge: '抄作业',
        title: '30秒成片：今晚就能出大片',
        description: '万能大导公式：大师 + 镜头 + 光影 + 主体场景 + 胶片滤镜',
        items: [
          '📝 万能大导公式：[召唤大师] + [镜头距离/视角] + [光影开关/虚化开关] + [你要的主体与环境] + [胶片滤镜]',
          '🍿 今晚作业 1：`photography by Nick Knight` + `makeup shot, DOF` + `neon lighting, bokeh` + `a beautiful cyberpunk girl in Tokyo night street` + `film grain`',
          '🦖 今晚作业 2：`photography by Andreas Gursky` + `extremely long shot, high angle shot` + `cinematic lighting, film still` + `Godzilla destroying a flaming city, massive smoke` + `Kodak 400`'
        ]
      },
      {
        type: 'important',
        badge: 'FAQ',
        title: '新手避坑（最常翻车的两个问题）',
        description: '这两条记住，能帮你省掉大量错误试错。',
        items: [
          '🙋‍♂️ 问：为什么我写了全景和特写，AI 出来的图怪怪的？答：因为你让 AI 精神分裂了！`close up shot` 和 `panorama` 是冲突词。',
          '🙋‍♀️ 问：提示词是不是写得越长、像写作文一样越好？答：错！AI 喜欢“标签词”，不喜欢“小作文”。词数控制在 50 个单词以内，精简干脆。'
        ]
      },
      {
        type: 'important',
        badge: '范式',
        title: '终极彩蛋 + 内部机密词典',
        description: '🤫 专属福利发放：我们的教研团队，将行业内最顶尖的提示词，整理成了一份《风变野菩萨·AI导演内部机密词典》。',
        items: [
          '👇 如何获取？今晚完成上述任意一个“抄作业”打卡，将你生成的绝美图片发到专属社群，并 @ 班主任。即可免费领取这份高清版【机密词典】原图！',
          '今晚，尽情去抽卡、去试错！明天，带着你最骄傲的一张神级照片，我们进入下一课：让你的绝美画面，变成有灵魂的爆款视频！'
        ]
      },
      {
        type: 'important',
        badge: '资料',
        title: '【提示词】摄影范式：摄影提示词结构范式',
        description: '此资料用于本课提示词结构搭建与复盘。',
        links: [
          { url: 'https://docs.qq.com/sheet/DSXRNUGJIQ0tMWkhu?tab=BB08J2', label: '🧩 打开摄影范式表' }
        ]
      },
      {
        type: 'tool',
        badge: '工具',
        title: '风变 Midjourney 工具',
        description: '用于作业2出图，可直接进行提示词创作、describe 与 shorten。',
        links: [
          { url: 'https://art.forchange.cn/mj', label: '🚀 打开风变MJ工具' }
        ]
      }
    ],
    practiceTasks: [
      {
        step: 1,
        title: '先看完开营首播主课视频',
        description: '先完整观看第1课视频，再进入下方实操任务。',
        lessons: [
          '重点看懂：提示词是权重，不是命令',
          '重点看懂：5个开关分别解决什么问题',
          '重点看懂：同类词叠加，相反概念二选一'
      ...
      },
      {
        step: 2,
        title: '先做“认知颠覆笔记”',
        description: '把“提示词是权重，不是命令”用你自己的话写成3句，并给出1个冲突词例子。',
        tasks: [
          '必须写出：为什么AI会把全身照画成大头贴',
          '必须写出：你准备如何给目标效果加“筹码”',
          '必须写出：一个冲突词对（例如 close up vs panorama）'
        ]
      },
      {
        step: 3,
        title: '今晚抄作业二选一（必须出图）',
        description: '作业1赛博人像 / 作业2哥斯拉海报，至少完成1个。',
        tips: [
          '赛博人像关键词：DOF + bokeh + neon lighting + film grain',
          '哥斯拉海报关键词：extremely long shot + high angle + film still + Kodak 400',
          '别改太多，先原样跑一版，再做小幅迭代'
        ]
      },
      {
        step: 4,
        title: '提交打卡，领取机密词典',
        description: '把你最满意的一张图发到群里并@班主任，领取内部机密词典。',
        actionLinks: [
          { url: 'https://art.forchange.cn/mj', text: '🚀 打开风变MJ开始创作' }
        ]
      }
    ],
    chapterTask: {
      description: '我已完成第1课打卡并提交一张“降维打击”级作品',
      tips: '进入下一章，学习如何让“绝美画面”变成“有灵魂的组图表达”'
    }
  },
  {
    id: 'chapter5',
    number: 5,
    title: '第2课：摄影艺术进阶（后三招）',
    icon: '🎞',
    customHtml: `
<div class="container chapter5-custom">
    ...
    `,
    objectives: [
      '理解“内容-形式-风格”三位一体的创作思路',
      '学会用组图关系（并列/递进/对比）讲清一个主题',
      '完成作业2两张目标图：手视角 + 双重曝光'
    ],
    resources: [
      {
        type: 'required',
        badge: '第2课',
        title: '摄影艺术进阶：摄影师的后三招',
        description: '这一课会把你从“会生成图片”，推进到“会设计一组有表达力的作品”。',
        items: [
          '核心升级：从“画面好看”升级到“画面有观点”',
          '重点模块：内容与风格 / 图像关系 / 摄影之外的艺术',
          '建议学习顺序：看视频 → 看案例 → 做作业2实战'
        ],
        links: [
          { url: 'https://fc0.cc/320e1t/1G1hw', label: '📺 观看第2课视频：摄影师的后三招' }
        ]
      },
      {
        type: 'important',
        badge: '案例',
        title: '小白可直接套用的组图叙事框架',
        description: '先把故事结构搭好，再写提示词，效率会高很多。',
        items: [
          '四图常见结构：起（交代）→ 承（推进）→ 转（冲突）→ 合（收束）',
          '每一图都要有“新增信息”，避免四图只是同一画面换姿势',
          '优先确保“角色一致 + 风格一致 + 光线逻辑一致”'
        ]
      },
      {
        type: 'important',
        badge: '范式',
        title: '提示词结构范式（第2课继续使用）',
        description: '用同一套结构写两种风格：手视角 / 双重曝光。',
        links: [
          { url: 'https://docs.qq.com/sheet/DSXRNUGJIQ0tMWkhu?tab=BB08J2', label: '🧩 打开摄影范式表' }
        ]
      },
      {
        ...
        badge: '工具',
        title: '风变 Midjourney 工具',
        description: '用于第2课实战出图。',
        links: [
          { url: 'https://art.forchange.cn/mj', label: '🚀 进入风变MJ开始出图' }
        ]
      }
    ],
    practiceTasks: [
      {
        step: 1,
        title: '先完成第2课学习与案例拆解',
        description: '从课中任选1个案例，写下“主题、形式、内容”三点拆解。',
        lessons: [
          '主题：它在讨论什么问题（情绪、议题、观点）',
          '形式：它用了什么结构（并列、递进、对比、呼应）',
          '内容：它通过哪些画面元素完成表达'
        ]
      },
      {
        step: 2,
        title: '完成作业2：手视角出图',
        description: '重点控制第一人称视角、前景手部、主体临场感。',
        exampleLabel: '手视角目标示例',
        example: '小技巧：先锁定镜头角度，再去调风格词和氛围词，稳定性更高。',
        exampleImages: [
          '/homework2/hand-perspective-reference.png'
        ]
      },
      {
        step: 3,
        title: '完成作业2：双重曝光出图',
        description: '重点控制“轮廓主体 + 内部场景叠加 + 光影层次”。',
        exampleLabel: '双重曝光目标示例',
        example: '小技巧：主体轮廓尽量简洁，内部叠加场景要有明确主次。',
        exampleImages: [
          '/homework2/double-exposure-reference.png'
        ]
      },
      {
        step: 4,
        title: '挑选最终提交版本',
        description: '每个方向各选1张最佳图，检查清晰度、构图和风格一致性。',
        tips: [
          '手视角：看手部是否自然、透视是否合理',
          '双重曝光：看主体轮廓是否清晰、叠加是否干净'
        ]
      }
    ],
    ctaModalHtml: `
    ...
    `,
    chapterTask: {
      description: '我已完成第2课学习并产出作业2两张目标图',
      tips: '下一章完成群内 + 表单双提交，形成学习闭环'
    }
  },
  {
    id: 'chapter6',
...
<div class="container">
    ...
    objectives: [
      '理解景别如何控制叙事信息密度和情绪距离',
      '掌握常见运镜词并在提示词中准确调用',
      '把“景别 + 运镜”组合成可复用的镜头语言模板'
    ],
    chapterTask: {
      description: '我已经准备好学习景别和运镜了'
    }
  },
  {
    id: 'chapter8',
...
<div class="container">
    ...
    objectives: [
      '理解镜头语法如何影响观众情绪',
      '掌握五大镜头心法与 AI 组合逻辑',
      '能按“情绪配方”设计分镜并落地到 AI 生成'
    ],
    preTaskModule: {
      description: '任选1个景别镜头角度，生成一张“好看”的图片，提交到表单里，同时发【基础入门学习群】',
      submitUrl: 'https://forchangesz.feishu.cn/share/base/form/shrcnyEngJJgSJqdnp1FbMfizjf',
      note: '大家提交上来的图片，我们将会经过挑选，作为景别的课程案例，收录到社团手册里'
    },
    ctaModalHtml: `
      <div class="cta-box" style="padding: 0; background: transparent; box-shadow: none; position: relative;">
        <div style="position: absolute; top: -12px; left: -12px; background: #ef4444; color: white; font-weight: 900; font-size: 1.1rem; padding: 4px 12px; transform: rotate(-15deg); border-radius: 6px; box-shadow: 2px 4px 10px rgba(239, 68, 68, 0.4); z-index: 100;">彩蛋！！！</div>
...
<div class="container">
    ...
    objectives: [
      '掌握运镜视频中常见的情绪配方与镜头组合',
      '理解空间落差和视角切换带来的情绪放大机制',
      '能按配方完成一段具电影感的运镜分镜'
    ],
    chapterTask: {
      description: '我已经完成第3课的阅读学习，并大致理解了景别、运镜的搭配使用'
    }
  },
  {
    id: 'chapter10',
...
<div class="container">
  ...
  },
  {
    ...
    assignments: [
      {
        ...
        required: true,
        requirements: [
          '用Midjourney出一张"手视角"的图',
          '用Midjourney出一张"双重曝光效果"的图'
        ],
        tools: [
          {
            name: '风变MJ',
            url: 'https://art.forchange.cn/mj',
            desc: '点击打开'
          }
        ],
        submitUrl: 'https://forchangesz.feishu.cn/share/base/form/shrcnyEngJJgSJqdnp1FbMfizjf',
    ...
    chapterTask: {
      description: '我已完成作业2的群内和表单双提交',
      tips: '两个动作都要完成：群内发 #基础作业2 + 填提交表单'
    }
  }
]
